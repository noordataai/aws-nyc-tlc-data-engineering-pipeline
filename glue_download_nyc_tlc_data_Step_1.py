...
Looks for latest available month for the current year in current mode and 
...
def main():
    ...
    if job_type == 'current':
        ...
        elif latest_year > 2024 and latest_month == 1:
            logger.info(f"Only {latest_year}-01 available as latest, skipping partial year to avoid triggering on unreleased data")
